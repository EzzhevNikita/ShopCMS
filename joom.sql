...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 15 2019 г., 21:22
...
--
-- Структура таблицы `va9ug_action_logs`
--

CREATE TABLE `va9ug_action_logs` (
...
--
-- Дамп данных таблицы `va9ug_action_logs`
--

INSERT INTO `va9ug_action_logs` (`id`, `message_language_key`, `message`, `log_date`, `extension`, `user_id`, `item_id`, `ip_address`) VALUES
(1, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"484\",\"username\":\"mainAdmin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=484\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE\"}', '2019-02-15 17:53:42', 'com_users', 484, 0, 'COM_ACTIONLOGS_DISABLED'),
(2, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":\"484\",\"username\":\"mainAdmin\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=484\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2019-02-15 17:55:32', 'com_users', 484, 0, 'COM_ACTIONLOGS_DISABLED');

-- --------------------------------------------------------

--
-- Структура таблицы `va9ug_action_logs_extensions`
--

CREATE TABLE `va9ug_action_logs_extensions` (
  `id` int(10) UNSIGNED NOT NULL,
  `extension` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `va9ug_action_logs_extensions`
--

INSERT INTO `va9ug_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Структура таблицы `va9ug_action_logs_users`
--

CREATE TABLE `va9ug_action_logs_users` (
...
--
-- Структура таблицы `va9ug_action_log_config`
--

CREATE TABLE `va9ug_action_log_config` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Дамп данных таблицы `va9ug_action_log_config`
--

INSERT INTO `va9ug_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Структура таблицы `va9ug_assets`
--

CREATE TABLE `va9ug_assets` (
...
--
-- Дамп данных таблицы `va9ug_assets`
--

INSERT INTO `va9ug_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Структура таблицы `va9ug_associations`
--

CREATE TABLE `va9ug_associations` (
...
--
-- Структура таблицы `va9ug_banners`
--

CREATE TABLE `va9ug_banners` (
  `id` int(11) NOT NULL,
...
--
-- Структура таблицы `va9ug_banner_clients`
--

CREATE TABLE `va9ug_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Структура таблицы `va9ug_banner_tracks`
--

CREATE TABLE `va9ug_banner_tracks` (
...
--
-- Структура таблицы `va9ug_categories`
--

CREATE TABLE `va9ug_categories` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `va9ug_categories`
--

INSERT INTO `va9ug_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 484, '2019-02-15 17:46:12', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 484, '2019-02-15 17:46:12', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 484, '2019-02-15 17:46:12', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 484, '2019-02-15 17:46:12', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 484, '2019-02-15 17:46:12', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 484, '2019-02-15 17:46:12', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Структура таблицы `va9ug_contact_details`
--

CREATE TABLE `va9ug_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Структура таблицы `va9ug_content`
--

CREATE TABLE `va9ug_content` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Структура таблицы `va9ug_contentitem_tag_map`
--

CREATE TABLE `va9ug_contentitem_tag_map` (
  `type_alias` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Структура таблицы `va9ug_content_frontpage`
--

CREATE TABLE `va9ug_content_frontpage` (
...
--
-- Структура таблицы `va9ug_content_rating`
--

CREATE TABLE `va9ug_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `va9ug_content_types`
--

CREATE TABLE `va9ug_content_types` (
...
--
-- Дамп данных таблицы `va9ug_content_types`
--

INSERT INTO `va9ug_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Структура таблицы `va9ug_core_log_searches`
--

CREATE TABLE `va9ug_core_log_searches` (
...
--
-- Структура таблицы `va9ug_extensions`
--

CREATE TABLE `va9ug_extensions` (
...
--
-- Дамп данных таблицы `va9ug_extensions`
--

INSERT INTO `va9ug_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{\"name\":\"LIB_JOOMLA\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2019 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}', '{\"mediaversion\":\"4f4ea0c14981a8f3ef91bed2fba1e06b\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2019 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1550253187}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(600, 802, 'English (en-GB)', 'language', 'en-GB', '', 0, 1, 1, 1, '{\"name\":\"English (en-GB)\",\"type\":\"language\",\"creationDate\":\"February 2019\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2019 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.9.3\",\"description\":\"en-GB site language\",\"group\":\"\"}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(601, 802, 'English (en-GB)', 'language', 'en-GB', '', 1, 1, 1, 1, '{\"name\":\"English (en-GB)\",\"type\":\"language\",\"creationDate\":\"February 2019\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2019 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.9.3\",\"description\":\"en-GB administrator language\",\"group\":\"\"}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Структура таблицы `va9ug_fields`
--

CREATE TABLE `va9ug_fields` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `va9ug_fields_categories`
--

CREATE TABLE `va9ug_fields_categories` (
...
--
-- Структура таблицы `va9ug_fields_groups`
--

CREATE TABLE `va9ug_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Структура таблицы `va9ug_fields_values`
--

CREATE TABLE `va9ug_fields_values` (
...
--
-- Структура таблицы `va9ug_finder_filters`
--

CREATE TABLE `va9ug_finder_filters` (
...
--
-- Структура таблицы `va9ug_finder_links`
--

CREATE TABLE `va9ug_finder_links` (
...
--
-- Структура таблицы `va9ug_finder_links_terms0`
--

CREATE TABLE `va9ug_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `va9ug_finder_links_terms1`
--

CREATE TABLE `va9ug_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `va9ug_finder_links_terms2`
--

CREATE TABLE `va9ug_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `va9ug_finder_links_terms3`
--

CREATE TABLE `va9ug_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `va9ug_finder_links_terms4`
--

CREATE TABLE `va9ug_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `va9ug_finder_links_terms5`
--

CREATE TABLE `va9ug_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `va9ug_finder_links_terms6`
--

CREATE TABLE `va9ug_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `va9ug_finder_links_terms7`
--

CREATE TABLE `va9ug_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `va9ug_finder_links_terms8`
--

CREATE TABLE `va9ug_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `va9ug_finder_links_terms9`
--

CREATE TABLE `va9ug_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `va9ug_finder_links_termsa`
--

CREATE TABLE `va9ug_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `va9ug_finder_links_termsb`
--

CREATE TABLE `va9ug_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `va9ug_finder_links_termsc`
--

CREATE TABLE `va9ug_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `va9ug_finder_links_termsd`
--

CREATE TABLE `va9ug_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `va9ug_finder_links_termse`
--

CREATE TABLE `va9ug_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `va9ug_finder_links_termsf`
--

CREATE TABLE `va9ug_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Структура таблицы `va9ug_finder_taxonomy`
--

CREATE TABLE `va9ug_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Дамп данных таблицы `va9ug_finder_taxonomy`
--

INSERT INTO `va9ug_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `va9ug_finder_taxonomy_map`
--

CREATE TABLE `va9ug_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `va9ug_finder_terms`
--

CREATE TABLE `va9ug_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `va9ug_finder_terms_common`
--

CREATE TABLE `va9ug_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Дамп данных таблицы `va9ug_finder_terms_common`
--

INSERT INTO `va9ug_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Структура таблицы `va9ug_finder_tokens`
--

CREATE TABLE `va9ug_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `va9ug_finder_tokens_aggregate`
--

CREATE TABLE `va9ug_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `va9ug_finder_types`
--

CREATE TABLE `va9ug_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `va9ug_languages`
--

CREATE TABLE `va9ug_languages` (
...
--
-- Дамп данных таблицы `va9ug_languages`
--

INSERT INTO `va9ug_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Структура таблицы `va9ug_menu`
--

CREATE TABLE `va9ug_menu` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `va9ug_menu`
--

INSERT INTO `va9ug_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Структура таблицы `va9ug_menu_types`
--

CREATE TABLE `va9ug_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы `va9ug_menu_types`
--

INSERT INTO `va9ug_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `va9ug_messages`
--

CREATE TABLE `va9ug_messages` (
...
--
-- Структура таблицы `va9ug_messages_cfg`
--

CREATE TABLE `va9ug_messages_cfg` (
...
--
-- Структура таблицы `va9ug_modules`
--

CREATE TABLE `va9ug_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Дамп данных таблицы `va9ug_modules`
--

INSERT INTO `va9ug_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Структура таблицы `va9ug_modules_menu`
--

CREATE TABLE `va9ug_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `va9ug_modules_menu`
--

INSERT INTO `va9ug_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Структура таблицы `va9ug_newsfeeds`
--

CREATE TABLE `va9ug_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `va9ug_overrider`
--

CREATE TABLE `va9ug_overrider` (
...
--
-- Структура таблицы `va9ug_postinstall_messages`
--

CREATE TABLE `va9ug_postinstall_messages` (
...
--
-- Дамп данных таблицы `va9ug_postinstall_messages`
--

INSERT INTO `va9ug_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Структура таблицы `va9ug_privacy_consents`
--

CREATE TABLE `va9ug_privacy_consents` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `va9ug_privacy_requests`
--

CREATE TABLE `va9ug_privacy_requests` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `va9ug_redirect_links`
--

CREATE TABLE `va9ug_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `va9ug_schemas`
--

CREATE TABLE `va9ug_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `va9ug_schemas`
--

INSERT INTO `va9ug_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.9.3-2019-02-07');

-- --------------------------------------------------------

--
-- Структура таблицы `va9ug_session`
--

CREATE TABLE `va9ug_session` (
...
--
-- Дамп данных таблицы `va9ug_session`
--

INSERT INTO `va9ug_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
(0x61693674646932696772347461636474733537326b3475623537, 1, 1, 1550254188, 'joomla|s:736:\"\";', 0, ''),
(0x62336862646d617264317171356e616a6d30356b636265336936, 0, 0, 1550253298, 'joomla|s:936:\"\";', 484, 'mainAdmin'),
(0x69746b756c306c696e7332347565397538616774766e6e396130, 0, 1, 1550254176, 'joomla|s:736:\"\";', 0, ''),
(0x72696933656331346432636d3866367576316d6a7032666a7432, 1, 0, 1550253380, 'joomla|s:868:\"\";', 484, 'mainAdmin');

-- --------------------------------------------------------

--
-- Структура таблицы `va9ug_tags`
--

CREATE TABLE `va9ug_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы `va9ug_tags`
--

INSERT INTO `va9ug_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 484, '2019-02-15 17:46:12', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Структура таблицы `va9ug_template_styles`
--

CREATE TABLE `va9ug_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Дамп данных таблицы `va9ug_template_styles`
--

INSERT INTO `va9ug_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Структура таблицы `va9ug_ucm_base`
--

CREATE TABLE `va9ug_ucm_base` (
...
--
-- Структура таблицы `va9ug_ucm_content`
--

CREATE TABLE `va9ug_ucm_content` (
...
--
-- Структура таблицы `va9ug_ucm_history`
--

CREATE TABLE `va9ug_ucm_history` (
...
--
-- Структура таблицы `va9ug_updates`
--

CREATE TABLE `va9ug_updates` (
...
--
-- Структура таблицы `va9ug_update_sites`
--

CREATE TABLE `va9ug_update_sites` (
...
--
-- Дамп данных таблицы `va9ug_update_sites`
--

INSERT INTO `va9ug_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1550253335, ''),
...
--
-- Структура таблицы `va9ug_update_sites_extensions`
--

CREATE TABLE `va9ug_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Дамп данных таблицы `va9ug_update_sites_extensions`
--

INSERT INTO `va9ug_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 802),
(3, 28);
...
--
-- Структура таблицы `va9ug_usergroups`
--

CREATE TABLE `va9ug_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Дамп данных таблицы `va9ug_usergroups`
--

INSERT INTO `va9ug_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Структура таблицы `va9ug_users`
--

CREATE TABLE `va9ug_users` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `va9ug_users`
--

INSERT INTO `va9ug_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(484, 'Super User', 'mainAdmin', 'ezzhev-nikita@hotmail.com', '$2y$10$165Tl5KGZLlLcDYQ1giryuPFeYEapFq/MeTj4Ooq5j3dFW58aIPZ6', 0, 1, '2019-02-15 17:46:12', '2019-02-15 17:55:32', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `va9ug_user_keys`
--

CREATE TABLE `va9ug_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `va9ug_user_notes`
--

CREATE TABLE `va9ug_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `va9ug_user_profiles`
--

CREATE TABLE `va9ug_user_profiles` (
...
--
-- Структура таблицы `va9ug_user_usergroup_map`
--

CREATE TABLE `va9ug_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `va9ug_user_usergroup_map`
--

INSERT INTO `va9ug_user_usergroup_map` (`user_id`, `group_id`) VALUES
(484, 8);

-- --------------------------------------------------------

--
-- Структура таблицы `va9ug_utf8_conversion`
--

CREATE TABLE `va9ug_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Дамп данных таблицы `va9ug_utf8_conversion`
--

INSERT INTO `va9ug_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Структура таблицы `va9ug_viewlevels`
--

CREATE TABLE `va9ug_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Дамп данных таблицы `va9ug_viewlevels`
--

INSERT INTO `va9ug_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Индексы таблицы `va9ug_action_logs`
--
ALTER TABLE `va9ug_action_logs`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `va9ug_action_logs_extensions`
--
ALTER TABLE `va9ug_action_logs_extensions`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `va9ug_action_logs_users`
--
ALTER TABLE `va9ug_action_logs_users`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_notify` (`notify`);

--
-- Индексы таблицы `va9ug_action_log_config`
--
ALTER TABLE `va9ug_action_log_config`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `va9ug_assets`
--
ALTER TABLE `va9ug_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `va9ug_associations`
--
ALTER TABLE `va9ug_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Индексы таблицы `va9ug_banners`
--
ALTER TABLE `va9ug_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `va9ug_banner_clients`
--
ALTER TABLE `va9ug_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Индексы таблицы `va9ug_banner_tracks`
--
ALTER TABLE `va9ug_banner_tracks`
...
--
-- Индексы таблицы `va9ug_categories`
--
ALTER TABLE `va9ug_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `va9ug_contact_details`
--
ALTER TABLE `va9ug_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Индексы таблицы `va9ug_content`
--
ALTER TABLE `va9ug_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Индексы таблицы `va9ug_contentitem_tag_map`
--
ALTER TABLE `va9ug_contentitem_tag_map`
...
--
-- Индексы таблицы `va9ug_content_frontpage`
--
ALTER TABLE `va9ug_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Индексы таблицы `va9ug_content_rating`
--
ALTER TABLE `va9ug_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Индексы таблицы `va9ug_content_types`
--
ALTER TABLE `va9ug_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Индексы таблицы `va9ug_extensions`
--
ALTER TABLE `va9ug_extensions`
...
--
-- Индексы таблицы `va9ug_fields`
--
ALTER TABLE `va9ug_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Индексы таблицы `va9ug_fields_categories`
--
ALTER TABLE `va9ug_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Индексы таблицы `va9ug_fields_groups`
--
ALTER TABLE `va9ug_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Индексы таблицы `va9ug_fields_values`
--
ALTER TABLE `va9ug_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Индексы таблицы `va9ug_finder_filters`
--
ALTER TABLE `va9ug_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Индексы таблицы `va9ug_finder_links`
--
ALTER TABLE `va9ug_finder_links`
...
--
-- Индексы таблицы `va9ug_finder_links_terms0`
--
ALTER TABLE `va9ug_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `va9ug_finder_links_terms1`
--
ALTER TABLE `va9ug_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `va9ug_finder_links_terms2`
--
ALTER TABLE `va9ug_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `va9ug_finder_links_terms3`
--
ALTER TABLE `va9ug_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `va9ug_finder_links_terms4`
--
ALTER TABLE `va9ug_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `va9ug_finder_links_terms5`
--
ALTER TABLE `va9ug_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `va9ug_finder_links_terms6`
--
ALTER TABLE `va9ug_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `va9ug_finder_links_terms7`
--
ALTER TABLE `va9ug_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `va9ug_finder_links_terms8`
--
ALTER TABLE `va9ug_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `va9ug_finder_links_terms9`
--
ALTER TABLE `va9ug_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `va9ug_finder_links_termsa`
--
ALTER TABLE `va9ug_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `va9ug_finder_links_termsb`
--
ALTER TABLE `va9ug_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `va9ug_finder_links_termsc`
--
ALTER TABLE `va9ug_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `va9ug_finder_links_termsd`
--
ALTER TABLE `va9ug_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `va9ug_finder_links_termse`
--
ALTER TABLE `va9ug_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `va9ug_finder_links_termsf`
--
ALTER TABLE `va9ug_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Индексы таблицы `va9ug_finder_taxonomy`
--
ALTER TABLE `va9ug_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `va9ug_finder_taxonomy_map`
--
ALTER TABLE `va9ug_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Индексы таблицы `va9ug_finder_terms`
--
ALTER TABLE `va9ug_finder_terms`
...
--
-- Индексы таблицы `va9ug_finder_terms_common`
--
ALTER TABLE `va9ug_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Индексы таблицы `va9ug_finder_tokens`
--
ALTER TABLE `va9ug_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Индексы таблицы `va9ug_finder_tokens_aggregate`
--
ALTER TABLE `va9ug_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Индексы таблицы `va9ug_finder_types`
--
ALTER TABLE `va9ug_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Индексы таблицы `va9ug_languages`
--
ALTER TABLE `va9ug_languages`
...
--
-- Индексы таблицы `va9ug_menu`
--
ALTER TABLE `va9ug_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `va9ug_menu_types`
--
ALTER TABLE `va9ug_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Индексы таблицы `va9ug_messages`
--
ALTER TABLE `va9ug_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Индексы таблицы `va9ug_messages_cfg`
--
ALTER TABLE `va9ug_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Индексы таблицы `va9ug_modules`
--
ALTER TABLE `va9ug_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `va9ug_modules_menu`
--
ALTER TABLE `va9ug_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Индексы таблицы `va9ug_newsfeeds`
--
ALTER TABLE `va9ug_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Индексы таблицы `va9ug_overrider`
--
ALTER TABLE `va9ug_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `va9ug_postinstall_messages`
--
ALTER TABLE `va9ug_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Индексы таблицы `va9ug_privacy_consents`
--
ALTER TABLE `va9ug_privacy_consents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Индексы таблицы `va9ug_privacy_requests`
--
ALTER TABLE `va9ug_privacy_requests`
  ADD PRIMARY KEY (`id`);

--
-- Индексы таблицы `va9ug_redirect_links`
--
ALTER TABLE `va9ug_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Индексы таблицы `va9ug_schemas`
--
ALTER TABLE `va9ug_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Индексы таблицы `va9ug_session`
--
ALTER TABLE `va9ug_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `userid` (`userid`),
  ADD KEY `time` (`time`);

--
-- Индексы таблицы `va9ug_tags`
--
ALTER TABLE `va9ug_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `va9ug_template_styles`
--
ALTER TABLE `va9ug_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Индексы таблицы `va9ug_ucm_base`
--
ALTER TABLE `va9ug_ucm_base`
...
--
-- Индексы таблицы `va9ug_ucm_content`
--
ALTER TABLE `va9ug_ucm_content`
...
--
-- Индексы таблицы `va9ug_ucm_history`
--
ALTER TABLE `va9ug_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Индексы таблицы `va9ug_updates`
--
ALTER TABLE `va9ug_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Индексы таблицы `va9ug_update_sites`
--
ALTER TABLE `va9ug_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Индексы таблицы `va9ug_update_sites_extensions`
--
ALTER TABLE `va9ug_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Индексы таблицы `va9ug_usergroups`
--
ALTER TABLE `va9ug_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `va9ug_users`
--
ALTER TABLE `va9ug_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `va9ug_user_keys`
--
ALTER TABLE `va9ug_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Индексы таблицы `va9ug_user_notes`
--
ALTER TABLE `va9ug_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Индексы таблицы `va9ug_user_profiles`
--
ALTER TABLE `va9ug_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Индексы таблицы `va9ug_user_usergroup_map`
--
ALTER TABLE `va9ug_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Индексы таблицы `va9ug_viewlevels`
--
ALTER TABLE `va9ug_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT для таблицы `va9ug_action_logs`
--
ALTER TABLE `va9ug_action_logs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT для таблицы `va9ug_action_logs_extensions`
--
ALTER TABLE `va9ug_action_logs_extensions`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT для таблицы `va9ug_action_log_config`
--
ALTER TABLE `va9ug_action_log_config`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT для таблицы `va9ug_assets`
--
ALTER TABLE `va9ug_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT для таблицы `va9ug_banners`
--
ALTER TABLE `va9ug_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_banner_clients`
--
ALTER TABLE `va9ug_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_categories`
--
ALTER TABLE `va9ug_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT для таблицы `va9ug_contact_details`
--
ALTER TABLE `va9ug_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_content`
--
ALTER TABLE `va9ug_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_content_types`
--
ALTER TABLE `va9ug_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT для таблицы `va9ug_extensions`
--
ALTER TABLE `va9ug_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=803;

--
-- AUTO_INCREMENT для таблицы `va9ug_fields`
--
ALTER TABLE `va9ug_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_fields_groups`
--
ALTER TABLE `va9ug_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_finder_filters`
--
ALTER TABLE `va9ug_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_finder_links`
--
ALTER TABLE `va9ug_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_finder_taxonomy`
--
ALTER TABLE `va9ug_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `va9ug_finder_terms`
--
ALTER TABLE `va9ug_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_finder_types`
--
ALTER TABLE `va9ug_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_languages`
--
ALTER TABLE `va9ug_languages`
  MODIFY `lang_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `va9ug_menu`
--
ALTER TABLE `va9ug_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT для таблицы `va9ug_menu_types`
--
ALTER TABLE `va9ug_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `va9ug_messages`
--
ALTER TABLE `va9ug_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_modules`
--
ALTER TABLE `va9ug_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;

--
-- AUTO_INCREMENT для таблицы `va9ug_newsfeeds`
--
ALTER TABLE `va9ug_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_overrider`
--
ALTER TABLE `va9ug_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';

--
-- AUTO_INCREMENT для таблицы `va9ug_postinstall_messages`
--
ALTER TABLE `va9ug_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT для таблицы `va9ug_privacy_consents`
--
ALTER TABLE `va9ug_privacy_consents`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_privacy_requests`
--
ALTER TABLE `va9ug_privacy_requests`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_redirect_links`
--
ALTER TABLE `va9ug_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_tags`
--
ALTER TABLE `va9ug_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `va9ug_template_styles`
--
ALTER TABLE `va9ug_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT для таблицы `va9ug_ucm_content`
--
ALTER TABLE `va9ug_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_ucm_history`
--
ALTER TABLE `va9ug_ucm_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_updates`
--
ALTER TABLE `va9ug_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_update_sites`
--
ALTER TABLE `va9ug_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `va9ug_usergroups`
--
ALTER TABLE `va9ug_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT для таблицы `va9ug_users`
--
ALTER TABLE `va9ug_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=485;

--
-- AUTO_INCREMENT для таблицы `va9ug_user_keys`
--
ALTER TABLE `va9ug_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_user_notes`
--
ALTER TABLE `va9ug_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `va9ug_viewlevels`
--
ALTER TABLE `va9ug_viewlevels`
