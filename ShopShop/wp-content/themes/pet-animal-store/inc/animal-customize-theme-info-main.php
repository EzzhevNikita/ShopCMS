 ...
 *
 * @package WordPress
 * @subpackage Pet Animal Store Lite
 */

/**
 * Class Pet_Animal_Store_Customizer_Theme_Info_Main
 *
 * @since  1.0.0
 * @access public
 */
class Pet_Animal_Store_Customizer_Theme_Info_Main extends WP_Customize_Section {
