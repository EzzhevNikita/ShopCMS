 ...
 */
/**
 * Class Pet_Animal_Store_Customizer_Upsell_Section
 */
class Pet_Animal_Store_Customizer_Upsell_Section extends WP_Customize_Section {
	/**
	...
	/**
	 * Pet_Animal_Store_Customizer_Upsell_Section constructor.
	 */
	public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
		$manager->register_section_type( 'Pet_Animal_Store_Customizer_Upsell_Section' );
