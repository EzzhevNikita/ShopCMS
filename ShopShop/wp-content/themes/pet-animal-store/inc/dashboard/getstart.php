...
function pet_animal_store_admin_theme_style() {
   wp_enqueue_style( 'pet-animal-store-font', pet_animal_store_admin_font_url(), array() );
...
// Theme Font URL
function pet_animal_store_admin_font_url() {
	$font_url = '';
	$font_family = array();
...
<div class="wrapper-info">  
    <div class="tab-sec">
		<div class="tab">
			...
			<button class="tablinks home" onclick="openCity(event, 'tc_index')"><?php esc_html_e( 'Free Theme Information', 'pet-animal-store' ); ?></button>
		  	<button class="tablinks" onclick="openCity(event, 'tc_pro')"><?php esc_html_e( 'Premium Theme Information', 'pet-animal-store' ); ?></button>
		  	<button class="tablinks" onclick="openCity(event, 'tc_create')"><?php esc_html_e( 'Theme Support', 'pet-animal-store' ); ?></button>				
		</div>
		...
		<div  id="tc_index" class="tabcontent">
			...
			<div class="info-link">
				...
				<a href="<?php echo esc_url( PET_ANIMAL_STORE_DEMO_DATA ); ?>" target="_blank"><?php esc_html_e('Demo Data', 'pet-animal-store'); ?></a>
