...
define('PET_ANIMAL_STORE_SUPPORT','https://wordpress.org/support/theme/pet-animal-store/','pet-animal-store');
...
define('PET_ANIMAL_STORE_SITE_URL','https://www.themescaliber.com/themes/free-animal-pet-wordpress-theme/');

function pet_animal_store_credit_link() {
    echo "<a href=".esc_url(PET_ANIMAL_STORE_SITE_URL)." target='_blank'>".esc_html__('Pet Shop Theme','pet-animal-store')."</a>";
}
