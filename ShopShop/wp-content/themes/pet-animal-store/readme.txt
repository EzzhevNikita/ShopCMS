...
5	Font License:font-awesome/fonts/.
	License: SIL OFL 1.1
...
6   Customizer Licence
	All code, unless otherwise noted, is licensed under the GNU GPL, version 2 or later.
	2016 © Justin Tadlock.

7   Customizer Go Pro Section Licence:
	Customizer go pro section incorporates code from Zerif Lite theme.

8   Pixabay Images
    License: CC0 1.0 Universal (CC0 1.0)
    Source: https://pixabay.com/en/service/terms/

	Slider image, Copyright 12019
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://pixabay.com/en/puppy-dog-animal-domestic-adorable-1903013/

	Product image, Copyright Pexels
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://pixabay.com/en/adorable-dog-animal-breed-cute-1868871/

	Product image, Copyright Alexas_Fotos
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://pixabay.com/en/flamingo-bird-colorful-feather-3526365/

	Product image, Copyright DariuszSankowski
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://pixabay.com/en/cat-pet-cat-eyes-lying-red-animal-1044914/
